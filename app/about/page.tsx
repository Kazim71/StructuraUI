  ...
  return (
    <div className="min-h-screen bg-[#f8f7f3] text-[#3f403c] font-sans">
      ...
      <main className="max-w-4xl mx-auto px-6 py-24 text-center">
        <h1 className="text-5xl font-bold mb-6 text-[#3f403c]">About Us</h1>
        <p className="text-lg text-[#58554e] leading-relaxed mb-12">
          We are a team of dedicated engineers and designers who believe that building for the web should be an elegant, deliberate, and joyful experience.
        </p>
        <div className="h-64 w-full bg-[#e3decd] rounded-sm flex items-center justify-center border border-[#c7bd9b]">
          <span className="text-[#58554e] font-medium">Company history coming soon...</span>
        </div>
      </main>
    </div>
  );
