  ...
  return (
    <div className="min-h-screen bg-[#f8f7f3] text-[#3f403c] font-sans">
      ...
      <main className="max-w-4xl mx-auto px-6 py-24 text-center">
        <h1 className="text-5xl font-bold mb-6 text-[#3f403c]">Features</h1>
        <p className="text-lg text-[#58554e] leading-relaxed mb-12">
          This is a dummy page showcasing our deliberate approach to web design features. Our platform integrates generative AI, visual drag-and-drop mechanics, and secure cloud synchronization natively.
        </p>
        <div className="h-64 w-full bg-[#e3decd] rounded-sm flex items-center justify-center border border-[#c7bd9b]">
          <span className="text-[#58554e] font-medium">Feature details coming soon...</span>
        </div>
      </main>
    </div>
  );
